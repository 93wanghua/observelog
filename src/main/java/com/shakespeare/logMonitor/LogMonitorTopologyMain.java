package com.shakespeare.logMonitor;
...
import com.shakespeare.logMonitor.bolt.FilterBolt;
import com.shakespeare.logMonitor.bolt.PrepareRecordBolt;
import com.shakespeare.logMonitor.bolt.SaveMessage2MySql;
...
//        // 初始化配置信息
        SpoutConfig spoutConfig = new SpoutConfig(hosts, "logmonitor", "/logger", "log_monitor");
        // 在topology中设置spout
